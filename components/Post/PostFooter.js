...
const PostFooter = () => {
  ...
  return (
    <div className='w-full pb-12 justify-between font-medium text-gray-500 dark:text-gray-400'>
      <div className='flex flex-wrap sm:flex-nowrap sm:justify-between items-center justify-center rounded-none bg-gray-100 dark:bg-gray-700 relative gap-3 px-4 py-3'>
        ...
        <div className='flex flex-wrap gap-3'>
          {BLOG.showWeChatPay && (
            <button
              ...
              className='flex gap-1 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 hover:text-gray-600 dark:hover:text-gray-300 text-sm rounded-none px-4 py-2'
            >
