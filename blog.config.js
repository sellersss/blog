const BLOG = {
  title: 'shcrisp',
  author: 'S.H. Crisp',
  email: 'shcrisp@proton.me',
  link: 'https://crisp.sh',
  newsletter: 'Notionic Weekly',
  description: 'Reflections on people, places, & technology',
  lang: 'en-US', // ['en-US', 'zh-CN', 'zh-HK', 'zh-TW', 'ja-JP', 'es-ES']
  timezone: 'America/New_York', // See https://en.wikipedia.org/wiki/List_of_tz_database_time_zones for all options.
  ...
  socialLink: {
    twitter: 'https://twitter.com/empathsatan',
